...
(function ($) {
    ...
    function addFocusClass() {
        ...
        /*jQuery('#accessibilityMenu>li').focusout(function(e) {
            jQuery(this).removeClass('mFocus');
            console.log(1+'/n/');
        });*/
        ...
        //jQuery('#accessibilityMenu>li>ul.goiSearch input').focus(function(e) {
        //jQuery(this).closest('ul.goiSearch').css('display', 'block').css('visibility', 'visible');
